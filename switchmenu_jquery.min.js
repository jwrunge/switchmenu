...
{$(switch_out).animate({left:'-10em',opacity:'0'},200,'swing',function(){$('html, body').scrollTop(0);$(switch_in).scrollTop(0);$(switch_in).css('left','10em').css('opacity','0').show().animate({left:'0',opacity:'1.0'},200,'swing')})}
var SwitchMenu=function(menu_selector,screens)
{this.switchin=function(switch_in,switch_out,set=null)
{$(switch_out).animate({left:'-10em',opacity:'0'},200,'swing',function(){$('html, body').scrollTop(0);$(switch_in).scrollTop(0);$(switch_in).css('left','10em').css('opacity','0').show().animate({left:'0',opacity:'1.0'},200,'swing')})}
this.reset=function()
...
{$(current_screen).addClass(screen_class);if(index>0)
...
menu.children('a').removeClass('selected');$(this).addClass('selected')})}});$(screen_class).css('position','relative');$(screen_class).css('display','none');$(screen_class).first().css('display','')}
this.init()}
